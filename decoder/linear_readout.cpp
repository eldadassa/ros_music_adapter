...
LinearReadoutDecoder::runMUSIC()
{
...
#if DEBUG_OUTPUT
        //std::cout << "size_spike_data: "<<size_spike_data<<"; size_command_data: "<<size_command_data<<std::endl;
    ...
    std::cout << "decoder: total simtime: " << dt/1000000.0 << " received spikes " << num_spikes0 << " spikes decoded " << num_spikes_decoded << std::endl;
